...
\usepackage{url}
\usepackage{booktabs}
\title{Humanoid Contact Budgeting: ICLR Main-Conference Gate Archive}
\author{Anonymous Authors}
\begin{document}
\maketitle
\begin{abstract}
This document is not an ICLR main-conference submission. It is the v3 main-conference gate for a generated robotics draft about humanoid contact planning. The original research bet was: Budget contacts as scarce commitments across balance, manipulation, and recovery. After a stricter hostile review, the honest terminal decision is \textbf{KILL/ARCHIVE}. Submission-hardening version: v3.
\end{abstract}
...
\item Humanoid Locomotion and Manipulation: Current Progress and Challenges in Control, Planning, and Learning (2025)
\item Scaling Cross-Environment Failure Reasoning Data for Vision-Language Robotic Manipulation (2025)
\item Distilling Contact Planning for Fast Trajectory Optimization in Robot Air Hockey (2024)
\item Posture and balance control for humanoid robots in multi-contact scenarios based on Model Predictive Control (2014)
\end{itemize}
