...
PAPER = ROOT / "paper"
DOWNLOADS_PDF = Path("C:/Users/wangz/Downloads/117.pdf")
DESKTOP_PDF = Path("C:/Users/wangz/Desktop/117.pdf")
ROOT_PDF = ROOT.parent / "117.pdf"
CHILD_PDF = ROOT / "117.pdf"
...
def main():
    ...
    if summary.get("terminal_decision") != "STRONG_REVISE":
        fail("terminal decision must remain STRONG_REVISE")
    ...
    print(f"Paper 117 validation passed. SHA256={digest} pages={pages}")
